...
- Fat burners and "thermogenics." Effect sizes are trivial to nonexistent; the risk of
  stimulant stacking is not.
- BCAAs when total protein is adequate. Redundant.
- Testosterone boosters.
- Detox and cleanse products.
- Anything with a proprietary blend that hides doses.
- Anything whose primary evidence is a testimonial.
